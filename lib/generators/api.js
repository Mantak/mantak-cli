...
import { createFile, insertToFile, checkFileExists} from '../utils';
...
export function generateApi(name) {
  ...
  const comments = `// import ${fileName}`;
  const options = {or: [
