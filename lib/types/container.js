...
export function generateContainer(name) {
  ...
  if (name.indexOf(':') > 0) {
    ...
    containerPath = `imports/ui/front/containers/${snakeCasePath}/${snakeCaseName}.js`;
    componentPath = `imports/ui/front/components/${snakeCasePath}/${snakeCaseName}.js`;
    filePath = `../../components/${snakeCasePath}/${snakeCaseName}`;
  } else {
    const snakeCaseName = _.snakeCase(name);
    containerPath = `./imports/ui/front/containers/${snakeCaseName}.js`;
    componentPath = `./imports/ui/front/components/${snakeCaseName}.js`;
